...
const VendorShippingLabelsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createShippingLabels: async (purchaseOrderNumber, body, options = {}) => {
            // verify required parameter 'purchaseOrderNumber' is not null or undefined
            (0, common_1.assertParamExists)('createShippingLabels', 'purchaseOrderNumber', purchaseOrderNumber);
            // verify required parameter 'body' is not null or undefined
            (0, common_1.assertParamExists)('createShippingLabels', 'body', body);
...
const VendorShippingLabelsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createShippingLabels(purchaseOrderNumber, body, options) {
...
const VendorShippingLabelsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createShippingLabels(purchaseOrderNumber, body, options) {
...
class VendorShippingLabelsApi extends base_1.BaseAPI {
     ...
     */
    createShippingLabels(requestParameters, options) {
        return (0, exports.VendorShippingLabelsApiFp)(this.configuration).createShippingLabels(requestParameters.purchaseOrderNumber, requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a shipping label for the purchaseOrderNumber that you specify.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values then those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](doc:usage-plans-and-rate-limits-in-the-sp-api).
