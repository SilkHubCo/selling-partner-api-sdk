...
export declare const TokensApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createRestrictedDataToken(body: CreateRestrictedDataTokenRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateRestrictedDataTokenResponse>>;
};
/**
