...
/**
    ...
    * @enum {string}
    */
export declare enum ContainerIdentificationContainerIdentificationTypeEnum {
    Sscc = "SSCC",
    Amzncc = "AMZNCC",
    Gtin = "GTIN",
    Bps = "BPS",
...
/**
    ...
    * @enum {string}
    */
export declare enum ContainersContainerTypeEnum {
    Carton = "carton",
    Pallet = "pallet"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum ImportDetailsHandlingInstructionsEnum {
    Oversized = "Oversized",
    Fragile = "Fragile",
    Food = "Food",
...
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentTransactionTypeEnum {
    New = "New",
    Cancel = "Cancel"
}
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentCurrentShipmentStatusEnum {
    Created = "Created",
...
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentShipmentFreightTermEnum {
    Collect = "Collect",
    Prepaid = "Prepaid"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentConfirmationShipmentConfirmationTypeEnum {
    Original = "Original",
    Replace = "Replace"
}
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentConfirmationShipmentTypeEnum {
    TruckLoad = "TruckLoad",
...
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentConfirmationShipmentStructureEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum ShipmentStatusDetailsShipmentStatusEnum {
    Created = "Created",
    TransportationRequested = "TransportationRequested",
    CarrierAssigned = "CarrierAssigned",
    Shipped = "Shipped"
...
/**
    ...
    * @enum {string}
    */
export declare enum StopFunctionCodeEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum TransportationDetailsShipModeEnum {
    TruckLoad = "TruckLoad",
    LessThanTruckLoad = "LessThanTruckLoad",
    SmallParcel = "SmallParcel"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum TransportationDetailsForShipmentConfirmationTransportationModeEnum {
    Road = "Road",
    Air = "Air",
    Ocean = "Ocean"
}
...
export declare const VendorShippingApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    submitShipments: (body: SubmitShipments, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const VendorShippingApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    submitShipments(body: SubmitShipments, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SubmitShipmentConfirmationsResponse>>;
};
/**
...
export declare class VendorShippingApi extends BaseAPI {
     ...
     */
    getShipmentDetails(requestParameters?: VendorShippingApiGetShipmentDetailsRequest, options?: any): Promise<import("axios").AxiosResponse<GetShipmentDetailsResponse, any>>;
    /**
     * Submits one or more shipment confirmations for vendor orders.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     ...
     * @memberof VendorShippingApi
     */
    submitShipments(requestParameters: VendorShippingApiSubmitShipmentsRequest, options?: any): Promise<import("axios").AxiosResponse<SubmitShipmentConfirmationsResponse, any>>;
}
