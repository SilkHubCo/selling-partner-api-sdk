...
export declare const VendorTransactionApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getTransaction: (transactionId: string, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const VendorTransactionApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getTransaction(transactionId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetTransactionResponse>>;
};
/**
...
export declare class VendorTransactionApi extends BaseAPI {
     ...
     */
    getTransaction(requestParameters: VendorTransactionApiGetTransactionRequest, options?: any): Promise<import("axios").AxiosResponse<GetTransactionResponse, any>>;
}
