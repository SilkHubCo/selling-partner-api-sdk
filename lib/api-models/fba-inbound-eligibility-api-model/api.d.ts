...
export declare const FbaInboundApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getItemEligibilityPreview: (asin: string, program: "INBOUND" | "COMMINGLING", marketplaceIds?: Array<string>, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const FbaInboundApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getItemEligibilityPreview(asin: string, program: "INBOUND" | "COMMINGLING", marketplaceIds?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetItemEligibilityPreviewResponse>>;
};
/**
...
export declare class FbaInboundApi extends BaseAPI {
     ...
     */
    getItemEligibilityPreview(requestParameters: FbaInboundApiGetItemEligibilityPreviewRequest, options?: any): Promise<import("axios").AxiosResponse<GetItemEligibilityPreviewResponse, any>>;
}
