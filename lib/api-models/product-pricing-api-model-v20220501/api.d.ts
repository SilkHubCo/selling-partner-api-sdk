 ...
 * @enum {string}
 */
export declare enum CompetitiveSummaryIncludedData {
...
/**
    ...
    * @enum {string}
    */
export declare enum FeaturedBuyingOptionBuyingOptionTypeEnum {
    New = "New"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum FeaturedOfferSegmentCustomerMembershipEnum {
    Prime = "PRIME",
    NonPrime = "NON_PRIME"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum LowestPricedOffersInputOfferTypeEnum {
    Consumer = "CONSUMER"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum OfferSubConditionEnum {
    New = "New",
    Mint = "Mint",
    VeryGood = "VeryGood",
    Good = "Good",
...
/**
    ...
    * @enum {string}
    */
export declare enum PrimeDetailsEligibilityEnum {
    National = "NATIONAL",
    Regional = "REGIONAL",
    None = "NONE"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum SegmentedFeaturedOfferSubConditionEnum {
    New = "New",
    Mint = "Mint",
    VeryGood = "VeryGood",
    Good = "Good",
...
/**
    ...
    * @enum {string}
    */
export declare enum ShippingOptionShippingOptionTypeEnum {
    Default = "DEFAULT"
}
/**
...
export declare const ProductPricingApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getCompetitiveSummary: (requests: CompetitiveSummaryBatchRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getFeaturedOfferExpectedPriceBatch: (getFeaturedOfferExpectedPriceBatchRequestBody: GetFeaturedOfferExpectedPriceBatchRequest, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const ProductPricingApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getCompetitiveSummary(requests: CompetitiveSummaryBatchRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CompetitiveSummaryBatchResponse>>;
    /**
     * Returns the set of responses that correspond to the batched list of up to 40 requests defined in the request body. The response for each successful (HTTP status code 200) request in the set includes the computed listing price at or below which a seller can expect to become the featured offer (before applicable promotions). This is called the featured offer expected price (FOEP). Featured offer is not guaranteed, because competing offers may change, and different offers may be featured based on other factors, including fulfillment capabilities to a specific customer. The response to an unsuccessful request includes the available error text.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 0.033 | 1 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {GetFeaturedOfferExpectedPriceBatchRequest} getFeaturedOfferExpectedPriceBatchRequestBody The batch of &#x60;getFeaturedOfferExpectedPrice&#x60; requests.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getFeaturedOfferExpectedPriceBatch(getFeaturedOfferExpectedPriceBatchRequestBody: GetFeaturedOfferExpectedPriceBatchRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetFeaturedOfferExpectedPriceBatchResponse>>;
};
/**
...
export declare class ProductPricingApi extends BaseAPI {
     ...
     */
    getCompetitiveSummary(requestParameters: ProductPricingApiGetCompetitiveSummaryRequest, options?: any): Promise<import("axios").AxiosResponse<CompetitiveSummaryBatchResponse, any>>;
    /**
     * Returns the set of responses that correspond to the batched list of up to 40 requests defined in the request body. The response for each successful (HTTP status code 200) request in the set includes the computed listing price at or below which a seller can expect to become the featured offer (before applicable promotions). This is called the featured offer expected price (FOEP). Featured offer is not guaranteed, because competing offers may change, and different offers may be featured based on other factors, including fulfillment capabilities to a specific customer. The response to an unsuccessful request includes the available error text.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 0.033 | 1 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     ...
     * @memberof ProductPricingApi
     */
    getFeaturedOfferExpectedPriceBatch(requestParameters: ProductPricingApiGetFeaturedOfferExpectedPriceBatchRequest, options?: any): Promise<import("axios").AxiosResponse<GetFeaturedOfferExpectedPriceBatchResponse, any>>;
}
