...
export declare const SalesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getOrderMetrics: (marketplaceIds: Array<string>, interval: string, granularity: "Hour" | "Day" | "Week" | "Month" | "Year" | "Total", granularityTimeZone?: string, buyerType?: "B2B" | "B2C" | "All", fulfillmentNetwork?: string, firstDayOfWeek?: "Monday" | "Sunday", asin?: string, sku?: string, options?: any) => Promise<RequestArgs>;
};
/**
