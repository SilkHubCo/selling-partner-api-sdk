 ...
 * @enum {string}
 */
export declare enum AggregationFrequency {
    Week = "WEEK",
    Month = "MONTH",
    Quarter = "QUARTER",
    Year = "YEAR"
 ...
 * @enum {string}
 */
export declare enum AutoEnrollmentPreference {
    In = "OPTED_IN",
    Out = "OPTED_OUT"
}
/**
 ...
 * @enum {string}
 */
export declare enum EnrollmentMethod {
    Manual = "MANUAL",
    Automatic = "AUTOMATIC"
}
/**
 ...
 * @enum {string}
 */
export declare enum ListOfferMetricsSortKey {
 ...
 * @enum {string}
 */
export declare enum ListOffersSortKey {
    Asin = "ASIN",
...
export declare const OffersApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    listOfferMetrics: (body?: ListOfferMetricsRequest, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listOffers: (body?: ListOffersRequest, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const OffersApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listOfferMetrics(body?: ListOfferMetricsRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListOfferMetricsResponse>>;
    /**
     * Returns the details of a selling partner\'s replenishment program offers.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 1 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {ListOffersRequest} [body] The request body for the &#x60;listOffers&#x60; operation.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    listOffers(body?: ListOffersRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListOffersResponse>>;
};
/**
...
export declare class OffersApi extends BaseAPI {
     ...
     * @memberof OffersApi
     */
    listOfferMetrics(requestParameters?: OffersApiListOfferMetricsRequest, options?: any): Promise<import("axios").AxiosResponse<ListOfferMetricsResponse, any>>;
    /**
     * Returns the details of a selling partner\'s replenishment program offers.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 1 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     ...
     * @memberof OffersApi
     */
    listOffers(requestParameters?: OffersApiListOffersRequest, options?: any): Promise<import("axios").AxiosResponse<ListOffersResponse, any>>;
}
/**
 * SellingpartnersApi - axios parameter creator
 * @export
 */
export declare const SellingpartnersApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    getSellingPartnerMetrics: (body?: GetSellingPartnerMetricsRequest, options?: any) => Promise<RequestArgs>;
};
/**
 * SellingpartnersApi - functional programming interface
 * @export
 */
export declare const SellingpartnersApiFp: (configuration?: Configuration) => {
    /**
     * Returns aggregated replenishment program metrics for a selling partner.   **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 1 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {GetSellingPartnerMetricsRequest} [body] The request body for the &#x60;getSellingPartnerMetrics&#x60; operation.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getSellingPartnerMetrics(body?: GetSellingPartnerMetricsRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetSellingPartnerMetricsResponse>>;
};
/**
 * SellingpartnersApi - factory interface
 * @export
 */
export declare const SellingpartnersApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Returns aggregated replenishment program metrics for a selling partner.   **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 1 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     * @param {GetSellingPartnerMetricsRequest} [body] The request body for the &#x60;getSellingPartnerMetrics&#x60; operation.
     * @param {*} [options] Override http request option.
 ...
 * @extends {BaseAPI}
 */
export declare class SellingpartnersApi extends BaseAPI {
    /**
     * Returns aggregated replenishment program metrics for a selling partner.   **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 1 |  The `x-amzn-RateLimit-Limit` response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
     ...
     */
    getSellingPartnerMetrics(requestParameters?: SellingpartnersApiGetSellingPartnerMetricsRequest, options?: any): Promise<import("axios").AxiosResponse<GetSellingPartnerMetricsResponse, any>>;
}
