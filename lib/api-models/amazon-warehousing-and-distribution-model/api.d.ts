 ...
 * @enum {string}
 */
export declare enum CarrierCodeType {
    Scac = "SCAC"
}
/**
 ...
 * @enum {string}
 */
export declare enum DimensionUnitOfMeasurement {
    Inches = "INCHES",
 ...
 * @enum {string}
 */
export declare enum DistributionPackageType {
    Case = "CASE",
    Pallet = "PALLET"
}
/**
 ...
 * @enum {string}
 */
export declare enum InboundShipmentStatus {
    Created = "CREATED",
    Shipped = "SHIPPED",
 ...
 * @enum {string}
 */
export declare enum InventoryDetailsVisibility {
    Show = "SHOW",
    Hide = "HIDE"
}
/**
 ...
 * @enum {string}
 */
export declare enum InventoryUnitOfMeasurement {
 ...
 * @enum {string}
 */
export declare enum ShipmentSortableField {
 ...
 * @enum {string}
 */
export declare enum VolumeUnitOfMeasurement {
    CuIn = "CU_IN",
    Cbm = "CBM",
    Cc = "CC"
}
 ...
 * @enum {string}
 */
export declare enum WeightUnitOfMeasurement {
    Pounds = "POUNDS",
    Kilograms = "KILOGRAMS"
}
/**
...
export declare const AwdApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getInboundShipment: (shipmentId: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listInboundShipments: (sortBy?: "UPDATED_AT" | "CREATED_AT", sortOrder?: "ASCENDING" | "DESCENDING", shipmentStatus?: "CREATED" | "SHIPPED" | "IN_TRANSIT" | "RECEIVING" | "DELIVERED" | "CLOSED" | "CANCELLED", updatedAfter?: string, updatedBefore?: string, maxResults?: number, nextToken?: string, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listInventory: (sku?: string, sortOrder?: "ASCENDING" | "DESCENDING", details?: "SHOW" | "HIDE", nextToken?: string, maxResults?: number, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const AwdApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getInboundShipment(shipmentId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InboundShipment>>;
    /**
     * Retrieves a summary for all the inbound AWD shipments associated with a merchant, with the ability to apply optional filters.
     * @param {'UPDATED_AT' | 'CREATED_AT'} [sortBy] Field to sort results by. Required if &#x60;sortOrder&#x60; is provided.
     * @param {'ASCENDING' | 'DESCENDING'} [sortOrder] Sort the response in &#x60;ASCENDING&#x60; or &#x60;DESCENDING&#x60; order.
     ...
     * @throws {RequiredError}
     */
    listInventory(sku?: string, sortOrder?: "ASCENDING" | "DESCENDING", details?: "SHOW" | "HIDE", nextToken?: string, maxResults?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InventoryListing>>;
};
/**
...
export declare class AwdApi extends BaseAPI {
     ...
     * @memberof AwdApi
     */
    getInboundShipment(requestParameters: AwdApiGetInboundShipmentRequest, options?: any): Promise<import("axios").AxiosResponse<InboundShipment, any>>;
    /**
     * Retrieves a summary for all the inbound AWD shipments associated with a merchant, with the ability to apply optional filters.
     ...
     * @memberof AwdApi
     */
    listInboundShipments(requestParameters?: AwdApiListInboundShipmentsRequest, options?: any): Promise<import("axios").AxiosResponse<ShipmentListing, any>>;
    /**
     * Lists AWD inventory associated with a merchant with the ability to apply optional filters.
     ...
     * @memberof AwdApi
     */
    listInventory(requestParameters?: AwdApiListInventoryRequest, options?: any): Promise<import("axios").AxiosResponse<InventoryListing, any>>;
}
